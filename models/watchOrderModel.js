...
const WatchOrderModel1 =mongoose.models.WatchOrder || mongoose.model("WatchOrder", watchorderSchema);
let WatchOrderModel2;
const setupDb2Model = async () => {
  const conn2 = await connectDb2();
  if (conn2.models.WatchOrder) {
    WatchOrderModel2 = conn2.models.WatchOrder;
  } else {
    WatchOrderModel2 = conn2.model("WatchOrder", watchorderSchema);
  }
};

setupDb2Model();

export { WatchOrderModel1, WatchOrderModel2 };
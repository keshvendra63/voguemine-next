        ...
        <div className={styles.blogList}>
            {
                blogs && blogs?.map((item,index)=>{
                    ...
                    <Image src={modifyCloudinaryUrl(item?.images && item?.images[0]?.url) || logo} alt={item?.title} width={100} height={100} placeholder='blur' blurDataURL="data:image/jpeg;base64,..."/>

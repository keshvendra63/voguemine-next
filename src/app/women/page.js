...
const fetchMensData = async () => {
  // Connect to MongoDB
  try{
    const response=await fetch(`${process.env.API_PORT}collection/category?category=women`)
...
export async function generateMetadata() {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dqh6bd766/image/upload/c_limit,h_1000,f_auto,q_auto/v1712294902/yobby4ueygp6xuraay9h.webp",
      },
    ],
  },
  robots: {

...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dqh6bd766/image/upload/c_limit,h_1000,f_auto,q_30/v1726468497/yf1i2xjopwmnp9cszgtt.jpg",
      },
    ],
  },
  robots: {
...
const page = () => {
  return (
    <div className={styles.about}>
      ...
      <Image src="https://res.cloudinary.com/dqh6bd766/image/upload/c_limit,h_1000,f_auto,q_30/v1726468497/yf1i2xjopwmnp9cszgtt.jpg" alt="about voguemine" width={512} height={400} style={{width:"100%",height:"100%",objectFit:"contain"}}/>
      <div>

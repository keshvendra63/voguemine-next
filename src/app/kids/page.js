...
export async function generateMetadata() {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dqh6bd766/image/upload/c_limit,h_1000,f_auto,q_30/v1712141569/gl4h9csarmygvpfgsuka.jpg",
      },
    ],
  },
  robots: {
...
<Image src={modifyCloudinaryUrl(item?.images[0]?.url)} alt={item?.title} width={512} height={512} placeholder='blur'blurDataURL="data:image/jpeg;base64,..."/>              

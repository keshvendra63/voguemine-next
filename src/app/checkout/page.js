...
<div className={styles.checkoutItem}>
    ...
    <div style={{margin:"70px 1rem",display:"flex",justifyContent:"center",alignItems:"center",height:"80vh",width:"100%",flexDirection:"column",textAlign:"center"}}>
        ...
        <p style={{color:"#C3A37D",fontWeight:'600',fontSize:"25px",marginBottom:"20px"}}>Nothing In Your Cart for Checkout</p>
        <Link href="/home"><button style={{padding:"8px 20px",backgroundColor:"#C3A37D",color:"white",border:"none",letterSpacing:"1px",fontSize:"17px",fontWeight:"500",cursor:"pointer"}}>Let's Add Something</button></Link>
    </div>
    }
    </>

...
export async function PUT(request){
    ...
    try {
      ...
      const updatedOrder = await OrderModel1.findByIdAndUpdate(orderId, { orderType: 'COD' }, {
        new: true,
      });
      const updatedOrder1 = await OrderModel2.findByIdAndUpdate(orderId, { orderType: 'COD' }, {
        new: true,
      });

...
export async function PUT(req){
    ...
    const { name, ordernumber, email, orderId } = body;
    ...
    try {
      ...
      const updatedOrder = await WatchOrderModel1.findByIdAndUpdate(orderId, { orderStatus: 'Delivered' }, { new: true });
      const updatedOrder1 = await WatchOrderModel2.findByIdAndUpdate(orderId, { orderStatus: 'Delivered' }, { new: true });

...
export async function PUT(request){
    ...
    try {
      ...
      const updatedOrder = await WatchOrderModel1.findByIdAndUpdate(orderId, { orderType: 'COD' }, {
        new: true,
      });
      const updatedOrder1 = await WatchOrderModel2.findByIdAndUpdate(orderId, { orderType: 'COD' }, {
        new: true,
      });

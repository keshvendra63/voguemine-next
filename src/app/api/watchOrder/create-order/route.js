...
import {WatchProductModel1,WatchProductModel2} from "../../../../../models/watchProductModel"; // Your Product model
...
export async function POST(req,res){
  ...
  try {
    ...
    const order = await WatchOrderModel1.create({
      shippingInfo,
      orderItems,
      totalPrice,
      finalAmount,
    ...
    const order2 = await WatchOrderModel2.create({
      _id:order?._id,
      shippingInfo,
      orderItems,
      totalPrice,

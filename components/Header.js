...
<p>Rs. {item?.price * item?.quantity}</p>
              ...
              <div className={styles.cartCheckout} style={{right:carts?0:"-100%"}}>
                ...
                <Image src="https://cdn-icons-png.flaticon.com/512/11329/11329060.png" alt="" width={150} height={150} style={{aspectRatio:'1/1',marginBottom:"20px",objectFit:"cover"}}/>
                <p style={{color:"black",fontWeight:'600',fontSize:"25px",marginBottom:"20px"}}>Empty Cart</p>
                <Link href="/" onClick={(e)=>setCarts(false)}><button style={{padding:"8px 20px",backgroundColor:"black",color:"white",border:"none",letterSpacing:"1px",fontSize:"17px",fontWeight:"500",cursor:"pointer"}}>Let's Add Something</button></Link>
